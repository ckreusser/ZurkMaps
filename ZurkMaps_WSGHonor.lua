...
ZurkMapsWSGHonor = ZurkMapsWSGHonor or {}

local Honor = ZurkMapsWSGHonor
...
function Honor.Create(parentFrame, addonFrame, mapHeight, config)
    ...
    local bar = CreateFrame("Frame", "ZurkMapsWSGHonorBar", parentFrame, BackdropTemplateMixin and "BackdropTemplate" or nil)
    bar:SetWidth(18)
    bar:SetPoint("TOPRIGHT", parentFrame, "TOPLEFT", 3, -1)
    bar:SetPoint("BOTTOMRIGHT", parentFrame, "BOTTOMLEFT", 3, 1)
