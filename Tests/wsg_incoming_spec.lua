...
Equal(controller.overlays.ALLY_TUNNEL.texture.vertexColor[1], 0.12, "static Alliance art receives AB blue tint")
Equal(controller.overlays.ALLY_TUNNEL.texture.vertexColor[2], 0.36, "static Alliance art receives AB blue tint")
Equal(controller.overlays.ALLY_TUNNEL.texture.vertexColor[3], 1.00, "static Alliance art receives AB blue tint")
...
Equal(controller.overlays.HORDE_RAMP.texture.vertexColor[1], 1.00, "static Horde art receives AB red tint")
Equal(controller.overlays.HORDE_RAMP.texture.vertexColor[2], 0.20, "static Horde art receives AB red tint")
Equal(controller.overlays.HORDE_RAMP.texture.vertexColor[3], 0.16, "static Horde art receives AB red tint")
